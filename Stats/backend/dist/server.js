...
app.get('/api/generate-pdf', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const doc = yield (0, pdfGenerator_1.generatePDF)(school);
...
function drawPieChart(doc, data, centerX, centerY, radius, title, isFirstChart = false, legendBelow = false, multiLineLegend = false) {
    try {
        let currentAngle = 0;
            ...
            if (multiLineLegend) {
                ...
                data.forEach((item, index) => {
                    ...
                    doc.fillColor('black')
                        .fontSize(8)
                        .font('Helvetica')
                        .text(item.label, currentX + legendBoxSize + legendTextPadding, currentY, {
                        width: 45,
                        align: 'left'
                    });
                });
    ...
    try {
        ...
        if (isHorizontal) {
            ...
            data.forEach((item, index) => {
                ...
                doc.fontSize(8)
                    .fillColor('black')
                    .text(item.label, startX + 5, barY + (barHeight / 2) - 4, {
...
function getGradesDistribution(school) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      WHERE institucion_educativa = $1;
    `;
            const verifyResult = yield db_1.pool.query(verifyQuery, [decodeURIComponent(school)]);
    ...
    `;
            ...
            const result = yield db_1.pool.query(query, [decodeURIComponent(school)]);
...
app.get('/api/test-grades', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    `;
        ...
        console.log('Processing request for school:', {
            ...
            codePoints: Array.from(decodedSchool).map(char => { var _a; return (_a = char.codePointAt(0)) === null || _a === void 0 ? void 0 : _a.toString(16); })
        });
      ...
      LIMIT 5;
    `;
        const rawResult = yield db_1.pool.query(rawQuery, [decodedSchool]);
        ...
        const data = yield getGradesDistribution(decodedSchool);
        res.json({
...
app.get('/api/generate-all-pdfs', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
app.get('/api/debug-grades', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const school = req.query.school;
        if (!school) {
            return res.status(400).json({ error: 'School parameter is required' });
