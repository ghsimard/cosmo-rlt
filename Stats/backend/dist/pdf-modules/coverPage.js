...
function findImagePath(imageName) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const potentialPaths = [
            // Frontend build path
            path_1.default.join(__dirname, '..', '..', '..', 'frontend', 'build', 'images', imageName),
            // Frontend public path
            path_1.default.join(__dirname, '..', '..', '..', 'frontend', 'public', 'images', imageName),
            // Root public path
            path_1.default.join(__dirname, '..', '..', '..', '..', 'public', 'images', imageName),
            // Absolute path directly to the image file
            path_1.default.join('/Users/ghsimard/dev/-- COSMO PROJECT/Stats/frontend/public/images', imageName)
        ];
...
const generateCoverPage = (doc, school) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const rltLogoPath = yield findImagePath('RLT_logo.jpeg');
        const cltLogoPath = yield findImagePath('CLT_logo.jpeg');
        ...
        if (rltLogoPath) {
            try {
                doc.image(rltLogoPath, sideMargin, // X position at left margin
                logoY, {
        ...
        if (cltLogoPath) {
            try {
                doc.image(cltLogoPath, pageWidth - logoWidth + sideMargin / 2, // Extend into the margin area
                logoY, {
                    fit: [logoWidth, logoHeight] // Width and height constraints
                });
    ...
    if (school) {
        ...
        const entidadText = yield getEntidadTerritorial(school);
